/**
 * Data Transfer Object (DTO) for prove operations.
 *
 * @property {string} txHash - The transaction hash of a withdrawal operation that is waiting for a prove transaction.
...
export class ProveDto {
  /**
   * The transaction hash of a withdrawal operation that is awaiting a prove transaction.
